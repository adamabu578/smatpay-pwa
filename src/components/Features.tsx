...
const Features = () => {
    ...
    return (
        <section id="features" className="py-24 bg-[#1E1544] text-white overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    <div className="w-full lg:w-1/2 relative flex justify-center">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-[#251A5A] rounded-full blur-3xl -z-10"></div>
                        <img 
                            src="/mockup.png" 
                            alt="App Preview" 
                    ...
                    <div className="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-8">
                        {features.map((feature, index) => (
                            <div key={index} className="p-8 rounded-2xl bg-[#251A5A] border border-[#3e3863] hover:border-[#7C7AFF] hover:shadow-xl hover:shadow-[#7C7AFF]/10 transition-all group">
                                <div className="w-12 h-12 rounded-xl bg-[#1E1544] flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                                    {feature.icon}
                                </div>
